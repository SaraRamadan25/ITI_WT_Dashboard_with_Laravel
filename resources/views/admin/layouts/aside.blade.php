            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-id-badge"></i><a href="{{ route('students.create') }}"> Add Students</a></li>
                        <li><i class="fa fa-id-badge"></i><a href="{{ route('students.archive') }}"> Archived Students</a></li>
